...
\begin{flushleft}
    ...
    \small
    \faMobile \hspace{.5pt} \href{tel:+919790555473}{979-055-5473}
    $|$
    \small
  ...
  \resumeSubheading
      ...
      {Software Engineer I}{Jan 2020 \textbf{--} July 2022}
        \resumeItemListStart
            ...
            \resumeItem{Increased the adoption of the RBOR platform across BlackRock}
            \resumeItem{Spearheaded ingestion of securities data which brings in \textbf{600GB/week with 293 columns (100M rows)}}
            \resumeItem{Boosted query performance by \textbf{60 times}}  
        \resumeItemListEnd 
      \resumeSubheading
        {Mantra Labs}{Bangalore, India}
        {Software Engineering Intern}{Jan 2020 \textbf{--} July 2022}
          \resumeItemListStart
              \resumeItem{Analyzed the I2S protocol in its application to a solid-state microphone on the BeagleBone Black}
    ...
    \resumeSubheading
      ...
      {Student Researcher}{Sept 2018 \textbf{--}  Nov 2019}
        \resumeItemListStart
            ...
            \resumeItem{Led the development of the sensor localization and electrical driver subsystem}
    ...
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading       
        {\textbf{Contributor -  Vega} $|$ \emph{\href{https://github.com/rajasekarv/vega}{\color{blue}GitHub}}}{}
          \resumeItemListStart
            \resumeItem{Developed the distributed set subtract operation in Rust}
          \resumeItemListEnd
...
\section{Skills}
  \resumeSubHeadingListStart
    \small{\item{
        \textbf{Programming Languages:}{ C, C++, Java, Python, MATLAB, SQL, VHDL, Rust, Scala} \\
        \textbf{Technologies:}{ Git, Arduino, ROS, LaTeX, Spark, TensorFlow, PyTorch, Hadoop, Linux} \\
