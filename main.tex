...
\section{Education}
    ...
    \resumeSubheading
      ...
      {Masters in Mobile and IoT Engineering - 3.73/4.0}{May 2022 \textbf{--} Dec 2023}
        \resumeItemListStart
    ...
    \resumeSubheading
      ...
      {Bachelors in Electronics and Communication Engineering - 9.1/10}{July 2016 \textbf{--} June 2020}
        \resumeItemListStart
          ...
          % Systems Courses
           \resumeItem{Coursework - Digital Logic Design - FPGA and verilog, Machine to Machine communication, Information Theory and Coding, Advanced Micro-controllers}
        ...
        \resumeProjectHeading            
          {\textbf{Realtime Operating System Kernel}}{}
            \resumeItemListStart
              ...
              \resumeItem{Implemented context switching, mutex and priority based scheduling rate-monotonic and priority-ceiling protocol}
              \resumeItemListEnd 
...
\section{Skills}
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Technologies:}{Git, CUDA ,ROS, Apache Spark, Docker, Kubernetes, TensorFlow, PyTorch, Hadoop, Linux} \\
      }}
    % \vspace{-4pt}
  \resumeSubHeadingListEnd
