      ...
      \resumeSubHeadingListStart
        \resumeProjectHeading{\textbf{Dynamic Memory Allocator} $|$ \emph{\href{https://raw.githubusercontent.com/ajprabhu09/resume/master/placeholder.txt}{\color{blue}GitHub}}}{}
         ...
         {\textbf{CMU-TCP} $|$ \emph{\href{https://raw.githubusercontent.com/ajprabhu09/resume/master/placeholder.txt}{\color{blue}GitHub}}}{}
            \resumeItemListStart
              \resumeItem{An RFC compliant implementation of TCP protocol for reliable delivery and congestion control in C}
            \resumeItemListEnd
         
        \resumeProjectHeading            
          {\textbf{RTOS Kernel} $|$ \emph{\href{https://raw.githubusercontent.com/ajprabhu09/resume/master/placeholder.txt}{\color{blue}GitHub}}}{}
            \resumeItemListStart
              \resumeItem{Developed a Low-Level Realtime Kernel for the nrf52840 ARM Cortex M4 based board with task scheduling and mutexes in C}
            \resumeItemListEnd 
        ...
        \resumeProjectHeading       
          {\textbf{Contributor -  Vega} $|$ \emph{\href{https://github.com/rajasekarv/vega}{\color{blue}GitHub}}}{}
            \resumeItemListStart
              \resumeItem{Developed distributed set subtract operation in a low-level language (Rust) for the open source project which is an native (no language runtime) implementation of the Spark distributed query engine}
            \resumeItemListEnd
