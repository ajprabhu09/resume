    ...
    % Systems projects 
      ...
      {\textbf{X86 Back-trace}}{}
        ...
        \resumeProjectHeading
         {\textbf{C0C Compiler}}{}
            \resumeItemListStart
              \resumeItem{A turning complete safe subset of the C0 language (used at CMU to teach programming) extended with copying \textbf{garbage collector and aggressive optimization techniques} (Register Allocation, CSE.., and Dead code elimination).}
            \resumeItemListEnd
