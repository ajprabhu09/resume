...
\section{Education}
    ...
    \resumeSubheading
      ...
      {Master of Science in Mobile and IoT Engineering - 3.64/4.0}{May 2022 \textbf{--} December 2023}
        \resumeItemListStart
    ...
    % Systems projects 
     ...
     \resumeProjectHeading            
          {\textbf{Realtime Operating System Kernel}}{}
            \resumeItemListStart
              \resumeItem{A multithreaded kernel for the ARM cortex M4 in C and Assembly}
              \resumeItem{Implemented context switching, mutex, thread scheduling and kernel mode drivers for I2C, PWM, UART, GPIO}
            % \resumeItem{Developed kernel drivers and user api for \textbf{UART, GPIO, I2C and PWM peripherals}.}
              \resumeItemListEnd 
     ...
     \resumeProjectHeading
      {\textbf{Safety Oriented Operating System Kernel}}{}
         \resumeItemListStart
           \resumeItem{ An X86 kernel with keyboard, console and physical page manager with focus on safety using the guarantees of the rust compiler }
        \resumeItemListEnd
      ...
      % {\textbf{Zoe II Rover}}{}
      %    \resumeItemListStart
      %      \resumeItem{ Research project as part of CMU Robotics Institute working on the successor to the Zoe Rover}
      %      \resumeItem{Developing the 3-D drive controller for suspension-less traversal on extremely rough terrain}
    ...
    %  Put Certificate chain and padding oracle

        % Security
        % \resumeProjectHeading       
        %   {\textbf{Padding Oracle Attack on CBC encryption}}{}
        %     \resumeItemListStart
        %       \resumeItem{Implemented a python script to decrypt and encrypt text from a padding server using the fact that the server provides information about the validity of encrypted text's padding.}
        %     \resumeItemListEnd
      ...
      %         \resumeItemListEnd
        ...
        %     \resumeItemListStart
        %       \resumeItem{Developed a malloc package implementation that achieved a peak performance of 74\symbol{\%} utilization while maintaining a throughput of $\sim{~}$9000Kops in C }
        %     \resumeItemListEnd
  ...
  \resumeSubHeadingListStart
    \resumeSubheading
        ...
        {Engineering Intern}{May 2023 \textbf{--} August 2023}
          \resumeItemListStart
              \resumeItem{Developed a user-mode emulation framework for running camera software tests without needing a physical device using C++ and CMake}
              % \resumeItem{}
          \resumeItemListEnd 
  ...
  \resumeSubheading
      ...
      {Software Engineer}{Jan 2020 \textbf{--} July 2022}
        \resumeItemListStart
            ...
            \resumeItem{Employed industry standard frameworks such as Apache Spark and Airflow compute and automated workflows}
            \resumeItem{Spearheaded automated ingestion of securities data which pulls 600GB with 293 unique columns}
            \resumeItem{Boosted batch query performance of securities data by 10x as compared to original relational query engine}  
        \resumeItemListEnd 
      % \resumeSubheading
